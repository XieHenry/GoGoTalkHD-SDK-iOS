...
- (void)initContentView {
    ...
    [bgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_offset(LineH(180));
    }];
    ...
    [self.contentTextView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(bgView.mas_right).with.offset(-LineW(20));
    ...
    [self.alertContentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.contentTextView.mas_top).with.offset(LineY(8));
        make.left.equalTo(self.contentTextView.mas_left).with.offset(LineX(0));
